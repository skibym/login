intellisense.annotate(jQuery, {
  ...
  'grep': function() {
    ...
    ///   <param name="inverted" type="Boolean">If "inverted" is false, or not provided, then the function returns an array consisting of all elements for which "callback" returns true.  If "inverted" is true, then the function returns an array consisting of all elements for which "callback" returns false.</param>
    ///   <returns type="Array" />
    /// </signature>
  },
  'hasData': function() {
